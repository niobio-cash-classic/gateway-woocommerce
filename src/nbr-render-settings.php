...
{
    NBR__render_settings_page('general');
}
//function NBR__render_advanced_settings_page ()  { NBR__render_settings_page   ('advanced'); }
//===========================================================================
...
HHHH;
    ...
    $gateway_valid_for_use = NBR__is_gateway_valid_for_use($gateway_status_message);
    ...
    switch ($menu_page_name) {
      case 'general':
        echo  NBR__GetPluginNameVersionEdition();
        echo  $gateway_status_message . $exchange_rate_message;
        NBR__render_general_settings_page_html();
        break;
